...
get_header();
?>
<?php $kinh_nghiem_args = [ 'orderby' => 'date', 'order' => 'DESC', 'category_name' => 'kinh-nghiem', 'posts_per_page' => '20' ];  ?>
<?php
              $kinh_nghiem = new WP_Query( $kinh_nghiem_args );
              // echo "a";
              // echo $kinh_nghiem->found_posts;
              // the_post();
                          ?>
<section class="content">
    ...
    <div class="hvr-wobble-horizontal">
         ...
         <div class="hvr-wobble-horizontal">
           ...
           <div class="arrowLine2"><a href="{{Asset('tintuc')}}/{{$data_category->title}}"><span class="title-page-current">Kinh nghiệm</span></a></div>
               ...
               <div>
                 <a href="{{Asset('tintuc')}}/{{$item->category_title}}/{{$item->name}}-{{$item->id}}" title="">
                  ...
                  <div class="col-sm-5 " id="id_image">
                     ...
                     <img src="<?php echo THEME_URL; ?>/img/1216446098-sinh-vien-Harvard.jpg" class="img-responsive image-dot" alt=""/>
                     </a>
                  </div>
                  <div class="col-sm-7">
                    <b>
...
<h3 class="panel-title">TIN TỨC</h3>
 ...
 <ul class="link-panel">
  <?php $tin_tuc_args = [ 'orderby' => 'date', 'order' => 'DESC', 'category_name' => 'tin-tuc', 'posts_per_page' => '7' ];  ?>
<?php
