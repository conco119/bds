...
<html lang="<?php language_attributes(); ?>" >
  <head>
    ...
    <!-- <link rel="profile" href="/css/master.css"> -->
...
<header>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-2">
          <a href="/"><img src="<?php echo THEME_URL; ?>/img/logo.png" alt="Logo" /></a>
      </div>
       <div class="col-sm-2 banner1">

          <a href="/"><img class="img-responsive banner-img1" src="<?php echo THEME_URL; ?>/img/tuyendung.jpg" alt="Logo" /></a>
      </div>

      <div class="col-sm-6 banner1">

          <a href="/"><img class="img-responsive banner-img" src="<?php echo THEME_URL; ?>/img/dat-nha-be-banner-1.jpg" alt="Logo" /></a>
      </div>
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="login">
                        <div class="row">
                         ...
                         <div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-12 regis">Social</div>
                            </div>
                            <!--End row-->
                            <div class="row">
                                <div class="col-sm-12 line"></div>
                            ...
                            <!--End row-->
                            <div class="row col-sm-12 no-radius btnfa">
                                <a class="btn btn-social-icon btn-facebook tw">
                                <i class="fa fa-facebook fa-5x itw"></i>
                                </a>
                                <a class="btn btn-social-icon btn-twitter tw">
                                <i class="fa fa-twitter fa-5x itw"></i>
                                </a>
                                <a class="btn btn-social-icon btn-google-plus tw">
                                <i class="fa fa-google-plus fa-5x itw"></i>
                                </a>
                            </div>
                        </div>
                        <!--right-->
...
<div class="main-nav1">
  <div class="container-fluid container ">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://localhost/~mtd/bdsoff/"><span class="span-kinhnghiem"> Trang chủ</span></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href="http://localhost/~mtd/bdsoff/nha-dat-noi-bat/"><span class="span-kinhnghiem1">Nhà đất nổi bật</span></a></li>
              <li><a href="http://localhost/~mtd/bdsoff/nha-dat-khac/"><span class="span-kinhnghiem1">Nhà đất khác</span></a></li>
              <li><a href="http://localhost/~mtd/bdsoff/du-an/"><span class="span-kinhnghiem1">Dự án</span></a></li>
          </ul>
        </li>
         <li><a href="http://localhost/~mtd/bdsoff/tin-tuc/"><span class="span-kinhnghiem">Tin Tức</span></a></li>
          <li><a href="http://localhost/~mtd/bdsoff/kinh-nghiem/"><span class="span-kinhnghiem">Kinh Nghiệm</span></a></li>
         <!-- @if (Auth::check()) -->
          <li><a href="http://localhost/~mtd/bdsoff/wp-admin/post-new.php"><span class="span-kinhnghiem">Đăng Tin</span></a></li>
          <!-- @else -->
          <!-- <li><a id="btn-dangtin" data-toggle="modal" data-target="#loginModal" href="http://localhost/~mtd/bdsoff/wp-admin/post-new.php"><span class="span-kinhnghiem">Đăng Tin</span></a></li> -->
          <!-- @endif -->
            <li><a href="http://localhost/~mtd/bdsoff/lien-he/"><span class="span-kinhnghiem">Liên Hệ</span></a></li>
              <li><a href="http://localhost/~mtd/bdsoff/gioi-thieu/"><span class="span-kinhnghiem">Giới Thiệu</span></a></li>
              <!-- <li><a href="/"><span class="span-kinhnghiem">Tuyển Dụng</span></a></li> -->
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        ?>
        <li><a href="http://localhost/~mtd/bdsoff/wp-admin/"  class="btn1" ><span class="span-kinhnghiem">Đăng Nhập</span></a></li>
      <?php else: ?>
        <?php $current_user = wp_get_current_user();  ?>
      <li><a href="http://localhost/~mtd/bdsoff/wp-admin/"  class="btn1" ><span class="span-kinhnghiem"><?php echo $current_user->user_login ?></span></a></li>
    <?php endif; ?>
